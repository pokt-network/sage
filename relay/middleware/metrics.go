...
// Metrics returns a middleware that records relay metrics via recorder after
// each relay completes. The middleware always calls next.HandleRelay; recording
// is best-effort and never affects the returned error.
